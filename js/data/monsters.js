...
const MonsterData = {
  ...
  slime: {
    ...
    icon: '🟢',
    type: 'melee',
    baseStats: { hp: 20, damage: 5, armor: 0, magicResist: 0 },
    speed: 1.0,
    attackRange: 30,
    attackSpeed: 1.0,
    exp: 10,
  ...
  bat: {
    ...
    icon: '🦇',
    type: 'melee',
    baseStats: { hp: 15, damage: 4, armor: 0, magicResist: 0 },
    speed: 2.0,
    attackRange: 30,
    attackSpeed: 1.5,
    exp: 8,
  ...
  rat: {
    ...
    icon: '🐀',
    type: 'melee',
    baseStats: { hp: 18, damage: 6, armor: 0, magicResist: 0 },
    speed: 1.8,
    attackRange: 25,
    attackSpeed: 1.3,
    exp: 9,
  ...
  skeleton: {
    ...
    icon: '💀',
    type: 'melee',
    baseStats: { hp: 35, damage: 8, armor: 3, magicResist: 0 },
    speed: 1.2,
    attackRange: 35,
    attackSpeed: 1.0,
    exp: 15,
  ...
  zombie: {
    ...
    icon: '🧟',
    type: 'melee',
    baseStats: { hp: 50, damage: 10, armor: 2, magicResist: 5 },
    speed: 0.7,
    attackRange: 35,
    attackSpeed: 0.8,
    exp: 20,
  ...
  goblin: {
    ...
    icon: '👺',
    type: 'melee',
    baseStats: { hp: 30, damage: 7, armor: 1, magicResist: 0 },
    speed: 1.5,
    attackRange: 35,
    attackSpeed: 1.2,
    exp: 12,
  ...
  spider: {
    ...
    icon: '🕷️',
    type: 'melee',
    baseStats: { hp: 40, damage: 9, armor: 2, magicResist: 0 },
    speed: 1.8,
    attackRange: 35,
    attackSpeed: 1.4,
    exp: 18,
  ...
  ghost: {
    ...
    icon: '👻',
    type: 'ranged',
    baseStats: { hp: 25, damage: 12, armor: 0, magicResist: 20 },
    speed: 1.3,
    attackRange: 200,
    attackSpeed: 1.5,
    exp: 25,
  ...
  orc: {
    ...
    icon: '👹',
    type: 'melee',
    baseStats: { hp: 80, damage: 15, armor: 5, magicResist: 0 },
    speed: 1.0,
    attackRange: 40,
    attackSpeed: 0.9,
    exp: 35,
  ...
  darkMage: {
    ...
    icon: '🧙',
    type: 'ranged',
    baseStats: { hp: 45, damage: 18, armor: 2, magicResist: 15 },
    speed: 0.9,
    attackRange: 250,
    attackSpeed: 1.2,
    exp: 40,
  ...
  werewolf: {
    ...
    icon: '🐺',
    type: 'melee',
    baseStats: { hp: 60, damage: 14, armor: 4, magicResist: 5 },
    speed: 2.2,
    attackRange: 40,
    attackSpeed: 1.6,
    exp: 38,
  ...
  golem: {
    ...
    icon: '🗿',
    type: 'melee',
    baseStats: { hp: 150, damage: 20, armor: 15, magicResist: 10 },
    speed: 0.5,
    attackRange: 45,
    attackSpeed: 0.6,
    exp: 60,
  ...
  vampire: {
    ...
    icon: '🧛',
    type: 'melee',
    baseStats: { hp: 70, damage: 16, armor: 5, magicResist: 15 },
    speed: 1.8,
    attackRange: 40,
    attackSpeed: 1.3,
    exp: 55,
  ...
  wraith: {
    ...
    icon: '👤',
    type: 'ranged',
    baseStats: { hp: 55, damage: 22, armor: 0, magicResist: 30 },
    speed: 1.5,
    attackRange: 280,
    attackSpeed: 1.0,
    exp: 50,
  ...
  minotaur: {
    ...
    icon: '🐂',
    type: 'melee',
    baseStats: { hp: 120, damage: 25, armor: 8, magicResist: 5 },
    speed: 1.4,
    attackRange: 50,
    attackSpeed: 0.8,
    exp: 70,
  ...
  demon: {
    ...
    icon: '👿',
    type: 'ranged',
    baseStats: { hp: 80, damage: 28, armor: 8, magicResist: 20 },
    speed: 1.6,
    attackRange: 260,
    attackSpeed: 1.1,
    exp: 80,
  ...
  lich: {
    ...
    icon: '☠️',
    type: 'ranged',
    baseStats: { hp: 100, damage: 32, armor: 5, magicResist: 40 },
    speed: 1.0,
    attackRange: 300,
    attackSpeed: 0.9,
    exp: 100,
  ...
  dragon: {
    ...
    icon: '🐲',
    type: 'ranged',
    baseStats: { hp: 180, damage: 30, armor: 12, magicResist: 25 },
    speed: 1.2,
    attackRange: 280,
    attackSpeed: 0.8,
    exp: 120,
  ...
  deathKnight: {
    ...
    icon: '⚔️',
    type: 'melee',
    baseStats: { hp: 200, damage: 35, armor: 18, magicResist: 15 },
    speed: 1.3,
    attackRange: 55,
    attackSpeed: 1.0,
    exp: 150,
  ...
  elite_skeleton_king: {
    ...
    icon: '👑',
    type: 'elite',
    baseStats: { hp: 150, damage: 18, armor: 8, magicResist: 10 },
    speed: 1.1,
    attackRange: 45,
    attackSpeed: 1.0,
    exp: 80,
  ...
  elite_orc_chief: {
    ...
    icon: '🪓',
    type: 'elite',
    baseStats: { hp: 250, damage: 25, armor: 12, magicResist: 5 },
    speed: 1.2,
    attackRange: 50,
    attackSpeed: 0.9,
    exp: 100,
  ...
  fire_elemental: {
    ...
    icon: '🔥',
    type: 'elemental',
    baseStats: { hp: 60, damage: 15, armor: 0, magicResist: 20 },
    speed: 1.3,
    attackRange: 120,
    attackSpeed: 1.2,
    exp: 25,
  ...
  ice_elemental: {
    ...
    icon: '❄️',
    type: 'elemental',
    baseStats: { hp: 55, damage: 12, armor: 5, magicResist: 25 },
    speed: 1.0,
    attackRange: 130,
    attackSpeed: 1.0,
    exp: 25,
  ...
  earth_elemental: {
    ...
    icon: '🪨',
    type: 'elemental',
    baseStats: { hp: 120, damage: 18, armor: 15, magicResist: 5 },
    speed: 0.6,
    attackRange: 40,
    attackSpeed: 0.8,
    exp: 30,
  ...
  lightning_elemental: {
    ...
    icon: '⚡',
    type: 'elemental',
    baseStats: { hp: 45, damage: 20, armor: 0, magicResist: 30 },
    speed: 2.0,
    attackRange: 100,
    attackSpeed: 1.5,
    exp: 28,
  ...
  ghost: {
    ...
    icon: '👻',
    type: 'undead',
    baseStats: { hp: 40, damage: 14, armor: 0, magicResist: 40 },
    speed: 1.5,
    attackRange: 35,
    attackSpeed: 1.2,
    exp: 22,
  ...
  wraith: {
    ...
    icon: '💀',
    type: 'undead',
    baseStats: { hp: 70, damage: 22, armor: 0, magicResist: 50 },
    speed: 1.8,
    attackRange: 40,
    attackSpeed: 1.3,
    exp: 35,
  ...
  bone_knight: {
    ...
    icon: '🛡️',
    type: 'undead',
    baseStats: { hp: 90, damage: 20, armor: 12, magicResist: 5 },
    speed: 1.0,
    attackRange: 45,
    attackSpeed: 1.0,
    exp: 32,
  ...
  necromancer: {
    ...
    icon: '🧙',
    type: 'undead',
    baseStats: { hp: 50, damage: 25, armor: 2, magicResist: 30 },
    speed: 0.9,
    attackRange: 150,
    attackSpeed: 0.8,
    exp: 40,
  ...
  vampire: {
    ...
    icon: '🧛',
    type: 'undead',
    baseStats: { hp: 80, damage: 18, armor: 5, magicResist: 20 },
    speed: 1.6,
    attackRange: 35,
    attackSpeed: 1.4,
    exp: 38,
  ...
  mummy: {
    ...
    icon: '🧟',
    type: 'undead',
    baseStats: { hp: 100, damage: 16, armor: 8, magicResist: 10 },
    speed: 0.7,
    attackRange: 35,
    attackSpeed: 0.9,
    exp: 28,
  ...
  imp: {
    ...
    icon: '👿',
    type: 'demon',
    baseStats: { hp: 35, damage: 12, armor: 2, magicResist: 15 },
    speed: 1.8,
    attackRange: 90,
    attackSpeed: 1.3,
    exp: 20,
  ...
  succubus: {
    ...
    icon: '😈',
    type: 'demon',
    baseStats: { hp: 60, damage: 16, armor: 3, magicResist: 25 },
    speed: 1.5,
    attackRange: 100,
    attackSpeed: 1.1,
    exp: 35,
  ...
  hellhound: {
    ...
    icon: '🐕',
    type: 'demon',
    baseStats: { hp: 70, damage: 20, armor: 4, magicResist: 10 },
    speed: 2.2,
    attackRange: 35,
    attackSpeed: 1.5,
    exp: 30,
  ...
  demon_brute: {
    ...
    icon: '👹',
    type: 'demon',
    baseStats: { hp: 110, damage: 25, armor: 8, magicResist: 5 },
    speed: 0.9,
    attackRange: 45,
    attackSpeed: 0.9,
    exp: 40,
  ...
  giant_spider: {
    ...
    icon: '🕷️',
    type: 'beast',
    baseStats: { hp: 45, damage: 14, armor: 3, magicResist: 5 },
    speed: 1.7,
    attackRange: 30,
    attackSpeed: 1.4,
    exp: 20,
  ...
  scorpion: {
    ...
    icon: '🦂',
    type: 'beast',
    baseStats: { hp: 65, damage: 18, armor: 10, magicResist: 0 },
    speed: 1.2,
    attackRange: 40,
    attackSpeed: 1.0,
    exp: 25,
  ...
  basilisk: {
    ...
    icon: '🐍',
    type: 'beast',
    baseStats: { hp: 85, damage: 22, armor: 6, magicResist: 15 },
    speed: 1.1,
    attackRange: 50,
    attackSpeed: 1.1,
    exp: 38,
  ...
  griffin: {
    ...
    icon: '🦅',
    type: 'beast',
    baseStats: { hp: 75, damage: 20, armor: 7, magicResist: 10 },
    speed: 2.0,
    attackRange: 40,
    attackSpeed: 1.3,
    exp: 35,
  ...
  wyvern: {
    ...
    icon: '🐉',
    type: 'beast',
    baseStats: { hp: 95, damage: 24, armor: 8, magicResist: 15 },
    speed: 1.5,
    attackRange: 110,
    attackSpeed: 0.9,
    exp: 42,
  ...
  golem: {
    ...
    icon: '🗿',
    type: 'construct',
    baseStats: { hp: 130, damage: 22, armor: 20, magicResist: 10 },
    speed: 0.5,
    attackRange: 45,
    attackSpeed: 0.7,
    exp: 35,
  ...
  automaton: {
    ...
    icon: '🤖',
    type: 'construct',
    baseStats: { hp: 90, damage: 18, armor: 12, magicResist: 20 },
    speed: 1.0,
    attackRange: 80,
    attackSpeed: 1.0,
    exp: 32,
  ...
  elite_skeleton: {
    ...
    icon: '⚔️',
    type: 'elite',
    baseStats: { hp: 150, damage: 28, armor: 10, magicResist: 10 },
    speed: 1.2,
    attackRange: 50,
    attackSpeed: 1.1,
    exp: 60,
  ...
  elite_orc: {
    ...
    icon: '🪓',
    type: 'elite',
    baseStats: { hp: 180, damage: 32, armor: 8, magicResist: 5 },
    speed: 1.0,
    attackRange: 55,
    attackSpeed: 0.9,
    exp: 65,
  ...
  elite_mage: {
    ...
    icon: '🔮',
    type: 'elite',
    baseStats: { hp: 100, damage: 35, armor: 3, magicResist: 40 },
    speed: 1.0,
    attackRange: 160,
    attackSpeed: 0.8,
    exp: 70,
  ...
  boss_slime_king: {
    ...
    type: 'boss',
    floor: 5,
    baseStats: { hp: 300, damage: 18, armor: 5, magicResist: 10 },
    speed: 0.8,
    attackRange: 50,
    attackSpeed: 0.8,
    exp: 200,
  ...
  boss_skeleton_lord: {
    ...
    type: 'boss',
    floor: 10,
    baseStats: { hp: 500, damage: 28, armor: 12, magicResist: 15 },
    speed: 1.0,
    attackRange: 55,
    attackSpeed: 1.0,
    exp: 400,
  ...
  boss_dragon: {
    ...
    type: 'boss',
    floor: 15,
    baseStats: { hp: 800, damage: 40, armor: 20, magicResist: 30 },
    speed: 1.2,
    attackRange: 300,
    attackSpeed: 0.7,
    exp: 800,
  ...
  boss_demon_lord: {
    ...
    type: 'boss',
    floor: 20,
    baseStats: { hp: 1200, damage: 55, armor: 25, magicResist: 35 },
    speed: 1.5,
    attackRange: 60,
    attackSpeed: 1.1,
    exp: 1500,
  ...
  boss_lich_king: {
    ...
    type: 'boss',
    floor: 25,
    baseStats: { hp: 1500, damage: 50, armor: 15, magicResist: 50 },
    speed: 1.0,
    attackRange: 350,
    attackSpeed: 0.9,
    exp: 2500,
  ...
  boss_final: {
    ...
    type: 'boss',
    floor: 30,
    baseStats: { hp: 3000, damage: 80, armor: 35, magicResist: 50 },
    speed: 1.3,
    attackRange: 100,
    attackSpeed: 1.0,
    exp: 5000,
  ...
  summon_skeleton: {
    ...
    icon: '💀',
    type: 'summon',
    baseStats: { hp: 40, damage: 10, armor: 3, magicResist: 0 },
    speed: 1.2,
    attackRange: 35,
    attackSpeed: 1.0,
    exp: 0,
  ...
  summon_death_knight: {
    ...
    icon: '⚔️',
    type: 'summon',
    baseStats: { hp: 200, damage: 25, armor: 12, magicResist: 10 },
    speed: 1.3,
    attackRange: 50,
    attackSpeed: 1.0,
    exp: 0,
